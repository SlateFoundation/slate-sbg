...
folder are mapped to the application's root namespace, 'SlateStandardsBasedGradingTeacher'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SlateStandardsBasedGradingTeacher"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SlateStandardsBasedGradingTeacher' in the same way
as `"SlateStandardsBasedGradingTeacher/sass/src"`.
